...
save('Simulations_Jochmans_Hybrid_Design6_n25.mat','OUTPUT')
...
monte_dgp_secondstage_zij = cmle(1)*monte_dgp_secondstage(:,6) + cmle(2)*monte_dgp_secondstage(:,7) + cmle(3)*monte_dgp_secondstage(:,9);
...
zij_real = beta_21*monte_dgp_secondstage(:,6) + beta_22*monte_dgp_secondstage(:,7) + beta_23*monte_dgp_secondstage(:,9);
...
table_secondstage = array2table([monte_dgp_secondstage(:,6),monte_dgp_secondstage(:,7),monte_dgp_secondstage_mills,D_i,D_j,monte_dgp_secondstage(:,3)]);
second_stage = fitlm(table_secondstage,'Intercept',false);
betas = table2array(second_stage.Coefficients(1:3,1));

table_secondstage_real = array2table([monte_dgp_secondstage(:,6),monte_dgp_secondstage(:,7),secondstage_mills_real,D_i,D_j,monte_dgp_secondstage(:,3)]);
