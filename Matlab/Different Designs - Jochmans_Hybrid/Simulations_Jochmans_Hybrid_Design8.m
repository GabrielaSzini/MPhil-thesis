...
save('Simulations_Jochmans_Hybrid_Design8_n25.mat','OUTPUT')
...
monte_x2 = (rand(number_observations,1) + monte_fe_indices(:,3) + monte_fe_indices(:,4)) <=0.5;
...
W = inv(Q'*Q)'*(Q'*V*Q)*inv(Q'*Q); se = sqrt(diag(W)/(n*m)); %%%% Author: Gabriela Szini
