...
% initialization
CMLE = cell(R, 1); SECMLE = CMLE ; BETAS = CMLE;  FE_SELECTION = CMLE; ZIJ = CMLE;%SE_X = CMLE;
% Replications
parfor r=1:R, [CMLE{r} SECMLE{r} BETAS{r} FE_SELECTION{r} ZIJ{r}] = Simulation(n); end
...
function [cmle se_cmle betas FE_selection_real_estimated zij_real_estimated] = Simulation(n)
...
[betas zij_real_estimated] = SecondStage(monte_dgp_subset,condition_all,fe_xi_i_zeta_j_est,cmle,fixed_effects_selection,beta_21,beta_22,beta_23);
...
function [betas zij_real_estimated] = SecondStage(monte_dgp_subset,condition_all,fe_xi_i_zeta_j_est,cmle,fixed_effects_selection,beta_21,beta_22,beta_23)
