...
[fe_xi_i_zeta_j_est monte_dgp_subset monte_dgp_subset_subset fe_xi_i_zeta_j_comb] = FEHybridApproach(monte_dgp,combinations,ss,n,cmle);
FE_selection_real_estimated = [repmat(1:(n+n),1)', fixed_effects_selection, fe_xi_i_zeta_j_est];

%%%% Estimating the second stage %%%%

[betas zij_real_estimated monte_dgp_secondstage] = SecondStage(monte_dgp_subset,monte_dgp_subset_subset,fe_xi_i_zeta_j_est,cmle,fixed_effects_selection,beta_21,beta_22,beta_23);

function [fe_xi_i_zeta_j_est monte_dgp_subset monte_dgp_subset_subset fe_xi_i_zeta_j_comb] = FEHybridApproach(monte_dgp,combinations,s,n,cmle)
...
monte_dgp_subset_subset = ismember(ij_monte_dgp_subset,ij_combinations_subset);
...
function [betas zij_real_estimated monte_dgp_secondstage] = SecondStage(monte_dgp_subset,monte_dgp_subset_subset,fe_xi_i_zeta_j_est,cmle,fixed_effects_selection,beta_21,beta_22,beta_23)
% taking only combinations used in Jochmans
monte_dgp_secondstage = monte_dgp_subset((monte_dgp_subset_subset==1),:);
