...
%%%% Prelimiary/Simulations_Jochmans_Kyriazidou_preliminary
...
% initialization
CMLE = cell(R, 1); SECMLE = CMLE ; H_NC_TRUE = CMLE; H_NC_DELTA_TRUE = CMLE; BETAS_TRUE = CMLE; BETAS_CORRECTED_TRUE = CMLE; H_NC_ESTIMATED = CMLE; H_NC_DELTA_ESTIMATED = CMLE; BETAS_ESTIMATED = CMLE; BETAS_CORRECTED_ESTIMATED = CMLE;
% Replications
parfor r=1:R, [CMLE{r} SECMLE{r} H_NC_TRUE{r} H_NC_DELTA_TRUE{r} BETAS_TRUE{r} BETAS_CORRECTED_TRUE{r} H_NC_ESTIMATED{r} H_NC_DELTA_ESTIMATED{r} BETAS_ESTIMATED{r} BETAS_CORRECTED_ESTIMATED{r}] = Simulation(n, beta_11, beta_12, beta_21, beta_22, beta_23); disp(r);end
% prepare screem output
%TCMLE = (CMLE-ones(R,1)*theta)./SECMLE; aCMLE = abs(TCMLE)>=1.96;
%OUTPUT = [CMLE SECMLE TCMLE aCMLE];
OUTPUT = [CMLE SECMLE H_NC_TRUE H_NC_DELTA_TRUE BETAS_TRUE BETAS_CORRECTED_TRUE H_NC_ESTIMATED H_NC_DELTA_ESTIMATED BETAS_ESTIMATED BETAS_CORRECTED_ESTIMATED]
save('Simulations_Jochmans_Kyriazidou_Design1_n25.mat','OUTPUT')

function [cmle se_cmle h_nc_true h_nc_delta_true betas_true betas_corrected_true h_nc_estimated h_nc_delta_estimated betas_estimated betas_corrected_estimated] = Simulation(n, beta_11, beta_12, beta_21, beta_22, beta_23)
...
monte_x1 = normrnd(0, 1, [number_observations, 1]);
...
monte_y2 = (beta_21*monte_x1 + beta_22*monte_x2 + beta_23*monte_x3 + errors_selection)>=0;
monte_y1 = (beta_11*monte_x1 + beta_12*monte_x2 + errors_observation).*(monte_y2>0);
monte_y1(monte_y1==0) = NaN;

%put all in a matrix
monte_dgp = [monte_fe_indices(:,1),monte_fe_indices(:,2),monte_y1,monte_x1, monte_x2,monte_y2,monte_x3];
...
monte_x3_matrix = reshape(monte_dgp(:,7),n,n)';
...
% turning transformed data into column vectors and setting fixed parameters
x1_k = x1_k'; x2_k = x2_k'; x3_k = x3_k'; y1_k = y1_k'; y2_k = y2_k';
r=1; delta=0.1;

%%% true parameters, several possible h's
% for true second stage we set
cmle_1 = beta_21; cmle_2 = beta_22; cmle_3 = beta_23;
% setting different h's
h=0.5;
[h_nc_true_05 h_nc_delta_true_05 betas_true_05 betas_corrected_true_05] = Kyriazidou(cmle_1, cmle_2, cmle_3, x1_k, x2_k, x3_k, y1_k, y2_k, combinations, r, h, delta);
h=1;
...
h=2;
[h_nc_true_2 h_nc_delta_true_2 betas_true_2 betas_corrected_true_2] = Kyriazidou(cmle_1, cmle_2, cmle_3, x1_k, x2_k, x3_k, y1_k, y2_k, combinations, r, h, delta);
h=3;
[h_nc_true_3 h_nc_delta_true_3 betas_true_3 betas_corrected_true_3] = Kyriazidou(cmle_1, cmle_2, cmle_3, x1_k, x2_k, x3_k, y1_k, y2_k, combinations, r, h, delta);
h=5;
[h_nc_true_5 h_nc_delta_true_5 betas_true_5 betas_corrected_true_5] = Kyriazidou(cmle_1, cmle_2, cmle_3, x1_k, x2_k, x3_k, y1_k, y2_k, combinations, r, h, delta);
h=10;
[h_nc_true_10 h_nc_delta_true_10 betas_true_10 betas_corrected_true_10] = Kyriazidou(cmle_1, cmle_2, cmle_3, x1_k, x2_k, x3_k, y1_k, y2_k, combinations, r, h, delta);

h_nc_true = [h_nc_true_05, h_nc_true_1, h_nc_true_2, h_nc_true_3, h_nc_true_5, h_nc_true_10];
h_nc_delta_true = [h_nc_delta_true_05, h_nc_delta_true_1, h_nc_delta_true_2, h_nc_delta_true_3, h_nc_delta_true_5, h_nc_delta_true_10];
betas_true = [betas_true_05, betas_true_1, betas_true_2, betas_true_3, betas_true_5, betas_true_10];
betas_corrected_true = [betas_corrected_true_05, betas_corrected_true_1, betas_corrected_true_2, betas_corrected_true_3, betas_corrected_true_5, betas_corrected_true_10];

%%% true parameters, several possible h's
% for true second stage we set
cmle_1 = cmle(1); cmle_2 = cmle(2); cmle_3 = cmle(3);
% setting different h's
h=0.5;
[h_nc_estimated_05 h_nc_delta_estimated_05 betas_estimated_05 betas_corrected_estimated_05] = Kyriazidou(cmle_1, cmle_2, cmle_3, x1_k, x2_k, x3_k, y1_k, y2_k, combinations, r, h, delta);
h=1;
[h_nc_estimated_1 h_nc_delta_estimated_1 betas_estimated_1 betas_corrected_estimated_1] = Kyriazidou(cmle_1, cmle_2, cmle_3, x1_k, x2_k, x3_k, y1_k, y2_k, combinations, r, h, delta);
h=2;
[h_nc_estimated_2 h_nc_delta_estimated_2 betas_estimated_2 betas_corrected_estimated_2] = Kyriazidou(cmle_1, cmle_2, cmle_3, x1_k, x2_k, x3_k, y1_k, y2_k, combinations, r, h, delta);
h=3;
[h_nc_estimated_3 h_nc_delta_estimated_3 betas_estimated_3 betas_corrected_estimated_3] = Kyriazidou(cmle_1, cmle_2, cmle_3, x1_k, x2_k, x3_k, y1_k, y2_k, combinations, r, h, delta);
h=5;
[h_nc_estimated_5 h_nc_delta_estimated_5 betas_estimated_5 betas_corrected_estimated_5] = Kyriazidou(cmle_1, cmle_2, cmle_3, x1_k, x2_k, x3_k, y1_k, y2_k, combinations, r, h, delta);
h=10;
[h_nc_estimated_10 h_nc_delta_estimated_10 betas_estimated_10 betas_corrected_estimated_10] = Kyriazidou(cmle_1, cmle_2, cmle_3, x1_k, x2_k, x3_k, y1_k, y2_k, combinations, r, h, delta);

h_nc_estimated = [h_nc_estimated_05, h_nc_estimated_1, h_nc_estimated_2, h_nc_estimated_3, h_nc_estimated_5, h_nc_estimated_10];
h_nc_delta_estimated = [h_nc_delta_estimated_05, h_nc_delta_estimated_1, h_nc_delta_estimated_2, h_nc_delta_estimated_3, h_nc_delta_estimated_5, h_nc_delta_estimated_10];
betas_estimated = [betas_estimated_05, betas_estimated_1, betas_estimated_2, betas_estimated_3, betas_estimated_5, betas_estimated_10];
betas_corrected_estimated = [betas_corrected_estimated_05, betas_corrected_estimated_1, betas_corrected_estimated_2, betas_corrected_estimated_3, betas_corrected_estimated_5, betas_corrected_estimated_10];
