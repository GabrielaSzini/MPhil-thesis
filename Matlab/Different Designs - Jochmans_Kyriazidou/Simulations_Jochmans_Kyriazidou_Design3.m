...
% Replications
parfor r=1:R, [CMLE{r} SECMLE{r} H_NC_TRUE{r} H_NC_DELTA_TRUE{r} BETAS_TRUE{r} BETAS_CORRECTED_TRUE{r} H_NC_ESTIMATED{r} H_NC_DELTA_ESTIMATED{r} BETAS_ESTIMATED{r} BETAS_CORRECTED_ESTIMATED{r}] = Simulation(n, beta_11, beta_12, beta_21, beta_22, beta_23); end
...
save('Simulations_Jochmans_Kyriazidou_Design3_n25.mat','OUTPUT')
...
%put all in a matrix
monte_dgp = [monte_fe_indices(:,1),monte_fe_indices(:,2),monte_y1,monte_fe_indices(:,3),monte_fe_indices(:,4),monte_x1, monte_x2,monte_y2,monte_x3];
